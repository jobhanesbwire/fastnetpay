...
<form class="form-horizontal" method="post" role="form" action="{Text::url('')}settings/app-post"
    ...
    <div class="panel">
        <div class="panel-heading" role="tab" id="FooterSettings">
            <h3 class="panel-title">
                <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion"
                    href="#collapseFooterSettings" aria-expanded="false" aria-controls="collapseFooterSettings">
                    {Lang::T('Footer Settings')}
                </a>
            </h3>
        </div>
        <div id="collapseFooterSettings" class="panel-collapse collapse" role="tabpanel">
            <div class="panel-body">
                <div class="form-group">
                    <label class="col-md-3 control-label">{Lang::T('Footer Text')}</label>
                    <div class="col-md-5">
                        <input type="text" class="form-control" id="fastnetpay_footer_text"
                            name="fastnetpay_footer_text" value="{$_c['fastnetpay_footer_text']}"
                            placeholder="FASTNETPAY ISP Billing Platform">
                    </div>
                    <span class="help-block col-md-4">{Lang::T('Short text shown at the left side of the admin footer')}</span>
                </div>
                <div class="form-group">
                    <label class="col-md-3 control-label">{Lang::T('Footer HTML')}</label>
                    <div class="col-md-5">
                        <textarea class="form-control" id="fastnetpay_footer_html" name="fastnetpay_footer_html"
                            rows="3">{Lang::htmlspecialchars($_c['fastnetpay_footer_html'])}</textarea>
                        <span class="help-block">{Lang::T('Allowed tags are limited to safe links and basic text formatting')}</span>
                    </div>
                    <span class="help-block col-md-4">{Lang::T('Optional extra footer content')}</span>
                </div>
                <div class="form-group">
                    <label class="col-md-3 control-label">{Lang::T('Copyright')}</label>
                    <div class="col-md-5">
                        <input type="text" class="form-control" id="fastnetpay_footer_copyright"
                            name="fastnetpay_footer_copyright" value="{$_c['fastnetpay_footer_copyright']}"
                            placeholder="&copy; 2026 FASTNETPAY">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 control-label">{Lang::T('Company Name')}</label>
                    <div class="col-md-5">
                        <input type="text" class="form-control" id="fastnetpay_footer_company"
                            name="fastnetpay_footer_company" value="{$_c['fastnetpay_footer_company']}"
                            placeholder="{$_c['CompanyName']}">
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-md-3 control-label">{Lang::T('Company URL')}</label>
                    <div class="col-md-5">
                        <input type="url" class="form-control" id="fastnetpay_footer_company_url"
                            name="fastnetpay_footer_company_url" value="{$_c['fastnetpay_footer_company_url']}"
                            placeholder="https://example.com">
                    </div>
                    <span class="help-block col-md-4">{Lang::T('Only http and https URLs are displayed')}</span>
                </div>
                <div class="form-group">
                    <label class="col-md-3 control-label">{Lang::T('Powered by')}</label>
                    <div class="col-md-5">
                        <input type="hidden" name="fastnetpay_footer_powered" value="hide">
                        <label class="checkbox-inline">
                            <input type="checkbox" name="fastnetpay_footer_powered" value="show"
                                {if $_c['fastnetpay_footer_powered'] neq 'hide'}checked{/if}>
                            {Lang::T('Show PHPNuxBill/AdminLTE credit')}
                        </label>
                    </div>
                    <span class="help-block col-md-4">{Lang::T('Keep enabled when you want to show open-source credits')}</span>
                </div>
                <div class="form-group">
                    <label class="col-md-3 control-label">{Lang::T('Support Email')}</label>
                    <div class="col-md-5">
                        <input type="email" class="form-control" id="fastnetpay_footer_support_email"
                            name="fastnetpay_footer_support_email" value="{$_c['fastnetpay_footer_support_email']}"
