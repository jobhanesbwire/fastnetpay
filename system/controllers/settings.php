...
switch ($action) {
    ...
    case 'app':
        ...
        if (!empty(_get('testWa'))) {
            ...
            $result = Message::sendWhatsapp(_get('testWa'), 'FASTNETPAY Test Whatsapp');
        ...
        if (!empty(_get('testSms'))) {
            ...
            $result = Message::sendSMS(_get('testSms'), 'FASTNETPAY Test SMS');
        ...
        if (!empty(_get('testEmail'))) {
            ...
            Message::sendEmail(_get('testEmail'), 'FASTNETPAY Test Email', 'FASTNETPAY Test Email Body');
        ...
        if (!empty(_get('testTg'))) {
            ...
            $result = Message::sendTelegram('FASTNETPAY Test Telegram');
    ...
    case 'dbbackup':
        ...
        header('Content-Disposition: attachment;filename="fastnetpay_' . count($tables) . '_tables_' . date('Y-m-d_H_i') . '.json"');
